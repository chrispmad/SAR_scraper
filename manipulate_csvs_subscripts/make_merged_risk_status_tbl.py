...
for col in columns_to_update:
    ...
    if status_col in merged_risk_status.columns and col in merged_risk_status.columns:
        del merged_risk_status[status_col]
...
merged_risk_status.fillna("NA", inplace = True)  # Or use another placeholder or method as needed
